 ...
 * </pre>
 */
public final class ThreeToThreeSequencedThroughput_ObjectTest_Common<Publisher extends BasePublisher> extends AbstractPerfTestDisruptor
{
    ...
    public BasePublisher basePublisher;
    ...
    //private /*final*/ Publisher[] valuePublishers = new Publisher[NUM_PUBLISHERS];
...
/*
    public void addPublisher(Object publisher){
        valuePublishers[publishers_count++] = (LongArrayPublisher_Object)publisher;
        NUM_PUBLISHERS = publishers_count;
    }
*/
    ...
    void init()
    {
        ...
        for (int i = 0; i < NUM_PUBLISHERS; i++)
        {
            ...
            barriers[i] = buffers[i].newBarrier();
             ...
             valuePublishers[i] = basePublisher.createInstance(
                cyclicBarrier,
                buffers[i],
